...
-------------------
  ...
  cfg.buffFrame = {
    ...
    border = {
      texture           = "Interface\\AddOns\\AnyLua60\\A4U\\media\\normal",
      color             = { r = 0, g = 0, b = 0, a = 1}, --{ r = 0.4, g = 0.35, b = 0.35, },
    },
    background = {
  ...
  cfg.debuffFrame = {
    ...
    background = {
      show              = true,   --show backdrop
      edgeFile          = "Interface\\AddOns\\AnyLua60\\A4U\\media\\outer_shadow",
      color             = { r = 0, g = 0, b = 0, a = 0.6},----color             = { r = 0, g = 0, b = 0, a = 0.9} --{ r = 0.4, g = 0.35, b = 0.35, },
      inset             = 4,----inset             = 6,
      padding           = 3,----padding           = 4,
    },
    duration = {
  ...
  local function applySkin(b)
    ...
    elseif not debuff then
      border:SetVertexColor(cfg.border.color.r,cfg.border.color.g,cfg.border.color.b,cfg.border.color.a)
    end
  ...
  local function updateDebuffAnchors(buttonName,index)
    ...
    if index == 1 then
      if cfg.combineBuffsAndDebuffs then
        button:SetPoint("TOPRIGHT", rBFS_BuffDragFrame, "TOPRIGHT", 0, -100)----button:SetPoint("TOPRIGHT", rBFS_BuffDragFrame, "TOPRIGHT", 0, -buffFrameHeight*1.3+5)----DEBUFF位置
      else
